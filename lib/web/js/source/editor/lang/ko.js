...
KindEditor.lang({
	...
	'multJImage.uploadDesc' : '최대 이미지 개수: <%=uploadLimit%>개, 개당 이미지 크기: <%=sizeLimit%>',
	'multJImage.startUpload' : '업로드 시작',
	'multJImage.clearAll' : '모두 삭제',
	'multJImage.insertAll' : '모두 삽입',
	'multJImage.queueLimitExceeded' : '업로드 개수가 초과되었습니다.',
	'multJImage.fileExceedsSizeLimit' : '업로드 크기가 초과되었습니다.',
	'multJImage.zeroByteFile' : '파일 크기가 없습니다.',
	'multJImage.invalidFiletype' : '올바른 이미지가 아닙니다.',
	'multJImage.unknownError' : '알 수 없는 업로드 오류가 발생하였습니다.',
	'multJImage.pending' : '처리 중 ...',
	'multJImage.uploadError' : '업로드 오류',
