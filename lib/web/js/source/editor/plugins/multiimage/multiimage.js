...
KindEditor.plugin('multJImage', function(K) {
	var self = this, name = 'multJImage',
		formatUploadUrl = K.undef(self.formatUploadUrl, true),
		uploadJson = K.undef(self.uploadJson, self.basePath + 'php/upload_json.php'),
		imgPath = self.pluginsPath + 'multJImage/images/',
	...
	self.plugin.multJImageDialog = function(options) {
		...
		self.plugin.multJImageDialog({
			clickFn : function (urlList) {
				...
				K.each(urlList, function(i, data) {
					if (self.afterUpload) {
						self.afterUpload.call(self, data.url, data, 'multJImage');
					}
