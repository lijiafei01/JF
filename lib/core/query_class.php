...
class JQuery
{
	...
	{
		$this->tablePre = isset(JF::$app->config['DB']['tablePre'])?JF::$app->config['DB']['tablePre']:'';
		$this->table = $name;
	...
	public function find()
	{
        if( is_int($this->page) )
        {
            ...
            $this->paging = new JPaging($sql,$pagesize,$pagelength);
    ...
    {
        return $this->paging->getLastPage();
    }
