...
class HTMLPurifier_IDAccumulator
{
    ...
    public static function build($config, $context) {
        ...
        $id_accumulator->load($config->get('Attr.JDBlacklist'));
...
class HTMLPurifier_StringHashParser
{
     ...
     */
    public function parseMultJFile($file) {
        if (!file_exists($file)) return false;
        $ret = array();
        $fh = fopen($file, 'r');
        if (!$fh) return false;
...
class HTMLPurifier_URI
{
    ...
    public function validate($config, $context) {
        ...
        // scheme is in our registry, since a URJFilter may convert a
...
class HTMLPurifier_URIDefinition extends HTMLPurifier_Definition
{
    ...
    public function __construct() {
        $this->registerFilter(new HTMLPurifier_URJFilter_DisableExternal());
        $this->registerFilter(new HTMLPurifier_URJFilter_DisableExternalResources());
        $this->registerFilter(new HTMLPurifier_URJFilter_DisableResources());
        $this->registerFilter(new HTMLPurifier_URJFilter_HostBlacklist());
        $this->registerFilter(new HTMLPurifier_URJFilter_SafeIframe());
        $this->registerFilter(new HTMLPurifier_URJFilter_MakeAbsolute());
        $this->registerFilter(new HTMLPurifier_URJFilter_Munge());
    }
 ...
 *
 * The following contexts may be available while URJFilters are being
 * processed:
 *
 ...
 */
abstract class HTMLPurifier_URJFilter
{
    ...
    final public function parse($var, $type, $allow_null = false) {
        ...
        switch ($type) {
            ...
            case (self::ITEXT):
                ...
                if ($type == self::JString || $type == self::ITEXT) $var = strtolower($var);
                return $var;
            case (self::INT):
                if (!is_int($var)) break;
                return $var;
 ...
 *          will ignore the directive Attr:JDBlacklist, since it will only
...
class HTMLPurifier_AttrDef_HTML_ID extends HTMLPurifier_AttrDef
{
    ...
    public function validate($id, $config, $context) {
        ...
        $regexp = $config->get('Attr.JDBlacklistRegexp');
...
class HTMLPurifier_URJFilter_DisableExternal extends HTMLPurifier_URJFilter
{
...
class HTMLPurifier_URJFilter_DisableExternalResources extends HTMLPurifier_URJFilter_DisableExternal
{
...
class HTMLPurifier_URJFilter_DisableResources extends HTMLPurifier_URJFilter
{
...
class HTMLPurifier_URJFilter_HostBlacklist extends HTMLPurifier_URJFilter
{
...
class HTMLPurifier_URJFilter_MakeAbsolute extends HTMLPurifier_URJFilter
{
...
class HTMLPurifier_URJFilter_Munge extends HTMLPurifier_URJFilter
{
    public $name = 'Munge';
    public $post = true;
 ...
 * works safely.
 */
class HTMLPurifier_URJFilter_SafeIframe extends HTMLPurifier_URJFilter
{
