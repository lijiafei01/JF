 ...
 * @date 2015-08-06
 */
class JFileCache implements JCacheInte
{
	...
	{
		$this->cachePath = isset(JF::$app->config['cache']['path']) ? JF::$app->config['cache']['path'] : $this->cachePath;
		$this->cacheExt  = isset(JF::$app->config['cache']['ext'])  ? JF::$app->config['cache']['ext']  : $this->cacheExt;
	}
	...
	{
		return JFile::clearDir($this->cachePath);
	}
}