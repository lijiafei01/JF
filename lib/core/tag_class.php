	...
	public function translate($matches)
	{
		if($matches[1]!=='/')
		{
			switch($matches[2].$matches[3])
			{
                ...
                case 'js:': return JSPackage::load($matches[4]);
				case 'url:': return '<?php echo JUrl::creatUrl("'.$matches[4].'");?>';
                case 'webroot:': return '<?php echo JUrl::creatUrl("")."'.$matches[4].'";?>';
                case 'theme:': return '<?php echo JUrl::creatUrl("")."views/".$this->theme."/'.$matches[4].'";?>';
                case 'skin:': return '<?php echo JUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/'.$matches[4].'";?>';
